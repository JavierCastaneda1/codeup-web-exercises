...
let userTotal = parseFloat(prompt('Please submit your total bill for today?'));
let userTip = parseFloat(prompt('Please submit your percentage for the tip?'))/100;

alert("You'll add " + calculateTip(userTip, userTotal)+ "to the bill");
